...
A practical engineering guide to building AI systems for understanding the happiness

This is a fun guide that covers in-depth technical details on building a system that could optimize a person's happiness. If you don't have enough time now, bookmark it, because it requires a lot of attention.

## Why we are at the starting point we are today
